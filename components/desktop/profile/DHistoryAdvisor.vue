  ...
  <div class="history-container">
    <table class="table-booking">
      ...
      <tbody>
        ...
        >
          <td class="text-left">{{ history.advisor.code }}</td>

          <td class="text-left">
            {{ $lang(history.advisor.name_th, history.advisor.name_end) }}
          </td>
...
export default {
  ...
  methods: {
    async getBookingHistory() {
      let res = await this.$store.dispatch('advisor_booking/history', {
        page: this.page,
    ...
    unbooking(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          let res = await this.$store.dispatch('advisor_booking/unbooking', id)
