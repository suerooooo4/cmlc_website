        ...
        <v-row>
                ...
                <v-list-item-group v-model="selectedItem" color="#ffffff">
                  ...
                  >
                    <v-hover v-slot:default="{ hover }">
                      <v-list-item
                        @click="changeCategory(category.id, i),getMediaSearch(category.id)"
          ...
          <v-col cols="9">
            ...
            <div v-if="form.is_search" class="media-container">
              <v-row>
                <v-col v-for="media in mediaSearch" :key="media.id" cols="6">
                  ...
                  >
                    ...
                    <div class="media-info">
                      ...
                      <p class="media-creator">
                        ...
                        <span class="media-playlist-card white--text pl-1">
                          {{ $lang(media.name_th, media.name_en) }}
                        </span>
                      </p>
