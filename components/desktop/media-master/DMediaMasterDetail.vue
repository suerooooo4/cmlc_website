                    ...
                    <v-row>
                      ...
                      <v-col class="text-right">
                        ...
                        <p class="total-download">
                          {{
                            $t('MEDIA_MASTER.TOTAL_DOWNLOAD').replace(
                              '%s',
...
export default {
  ...
  data() {
    return {
      ...
      previous_page: this.$store.state.media_master.page,
      media: null,
      media_pdf: [],
    }
  },
  ...
  methods: {
    ...
    async updateTotalView() {
      await this.$store.dispatch('media_master/updateTotalView', this.id)
    },
