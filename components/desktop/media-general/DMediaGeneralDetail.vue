                    ...
                    <v-row>
                      ...
                      <v-col class="text-right">
                        ...
                        <p class="total-download">
                          {{
                            $t('MEDIA_GENERAL.TOTAL_DOWNLOAD').replace(
                              '%s',
  ...
  export default {
    ...
    data() {
      return {
        ...
        previous_page: this.$store.state.media_general.page,
        media: null,
        media_pdf: [],
      }
    },
    ...
    async getMediaUrl() {
      ...
      async getMedia() {
        let res = await this.$store.dispatch('media_general/find', this.id)
        this.media = res.data
      ...
      async updateTotalView() {
        await this.$store.dispatch('media_general/updateTotalView', this.id)
      },
