  ...
  <main class="main">
    <header class="header">
      <span class="header__topbar mt-4">
        <v-btn icon  @click=" openPage('/media-master/playlist', {media_playlist_id: media.media_playlist_id,})">
          <i class="back"></i>
        </v-btn>
        <a class="link"  @click=" openPage('/media-master/playlist', {media_playlist_id: media.media_playlist_id,})"
